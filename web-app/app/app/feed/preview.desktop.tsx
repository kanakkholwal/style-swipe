...
export default async function PreviewProduct({ slug }: { slug: string }) {
    ...
    if (!product)
        return <div className="absolute inset-0 bg-white p-5 delay-1000 animate-in slide-in-from-right duration-500 ease-in-out fill-mode-forwards">
    ...
    return <div className="absolute inset-0 bg-white p-5 delay-1000 animate-in slide-in-from-right duration-500 ease-in-out fill-mode-forwards">
        <Image src={product.image_url} width={200} height={200} alt={product.description} />
