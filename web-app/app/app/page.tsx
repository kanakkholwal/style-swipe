...
export default function Page() {
  return (
    <div className="pt-6 @container">
      ...
      <div className="grid gap-8 @lg:grid-cols-2 @2xl:grid-cols-3 @4xl:grid-cols-4">
        {routes.map((route) => (
...
function RouteCard({ route }: { route: Route }) {
  return (
    <Link
      href={route.path}
      className="text-center bg-white/30 backdrop-blur-lg p-8 rounded-xl border hover:shadow-lg"
    >
      <div className="mx-auto size-28 mb-4">{route.icon}</div>
